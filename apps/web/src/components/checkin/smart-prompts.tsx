      ...
      {suggestions.map((suggestion) => {
        ...
        return (
          <button
            ...
            type="button"
            className="group w-full rounded-lg border border-white/5 bg-white/[0.02] px-3 py-2.5 text-left transition-colors hover:border-indigo-500/30 hover:bg-indigo-500/5"
