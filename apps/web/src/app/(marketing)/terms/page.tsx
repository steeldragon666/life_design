  ...
  return (
    <main className="relative min-h-screen bg-[#0f0a1a] text-white overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-4 pb-24 pt-16 sm:px-6 lg:px-8">
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-white/10 bg-white/[0.03]">
                <th className="py-3 pl-5 pr-4 text-left font-semibold text-slate-300">Plan</th>
                <th className="px-4 py-3 text-left font-semibold text-slate-300">Price</th>
                <th className="py-3 pl-4 pr-5 text-left font-semibold text-slate-300">Billing</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-white/5">
              {[
                ...
                <tr key={plan} className="hover:bg-white/[0.02]">
                  ...
                  <td className="py-3 pl-4 pr-5 text-slate-400">{billing}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <ul className="mt-4 list-disc pl-5 space-y-1 text-sm text-slate-400">
        ...
        <address className="not-italic text-sm text-slate-400 space-y-1">
          ...
          <p>
            Email:{' '}
            <a href="mailto:legal@lifedesign.app" className="text-indigo-400 hover:underline">
